      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            dateDeDelegation: expect.any(Object),
            dateDeDelais: expect.any(Object),
            tarif: expect.any(Object),
            postulantRetenu: expect.any(Object),
            imageVideo: expect.any(Object),
            description: expect.any(Object),
            categories: expect.any(Object),
            mandataireDelegateur: expect.any(Object),
            postulants: expect.any(Object),
          })
        );
      });
