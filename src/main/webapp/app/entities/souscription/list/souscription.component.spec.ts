...
describe('Souscription Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'souscription', component: SouscriptionComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to souscriptionService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getSouscriptionIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getSouscriptionIdentifier).toHaveBeenCalledWith(entity);
