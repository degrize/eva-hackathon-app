...
@RestController
@RequestMapping("/api/eva-hackathon-app-kafka")
public class EvaHackathonAppKafkaResource {

    private final Logger log = LoggerFactory.getLogger(EvaHackathonAppKafkaResource.class);
    ...
    public EvaHackathonAppKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
