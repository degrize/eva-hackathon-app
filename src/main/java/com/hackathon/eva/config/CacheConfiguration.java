package com.hackathon.eva.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.hackathon.eva.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.hackathon.eva.repository.UserRepository.USERS_BY_EMAIL_CACHE);
